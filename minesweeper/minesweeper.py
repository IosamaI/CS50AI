...
class MinesweeperAI:
    ...
    def add_knowledge(self, cell, count):
        ...
        # 5. Infer new sentences based on subset relationships
        inferred_sentences = []
    ...
    def update_knowledge(self):
        """
        Iterates through the knowledge base to mark additional cells
        as safe or mines when possible.
        """

        safes_to_mark = set()
        mines_to_mark = set()

        # Collect all safes and mines from knowledge sentences
        for sentence in self.knowledge:
            safes_to_mark.update(sentence.known_safes())
            mines_to_mark.update(sentence.known_mines())

        # Mark the safes and mines
